...
## Description
Nate Herk explains Karpathy's LLM wiki pattern, shows a five-minute Obsidian setup with raw/wiki/index/log layers, compares it against traditional RAG, and adds practical ideas like a hot cache, domain subindexes, and recurring lint passes.
