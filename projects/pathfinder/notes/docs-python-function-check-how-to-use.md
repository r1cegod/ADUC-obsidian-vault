...
> **TL;DR**: This doc defines the cheap deterministic backend-check workflow that now sits beside replay eval in PathFinder's evaluation domain.
...
It also records the grouped command structure that now owns this work: shared stage-profile utils, orchestrator policy, stage-helper parity, and output/evaluation seams.
