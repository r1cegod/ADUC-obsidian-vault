...
- 2026-04-13 university-finding frontend run: `university_finding_frontend_report_2026-04-13.md`
- 2026-04-13 data-agent frontend audit: `data_agent_frontend_audit_2026-04-13.md`
- 2026-04-12 frontend trace output regression: `eval/live_frontend_output_regression_2026-04-12.jsonl`
- 2026-04-12 uncertainty attack: `uncertainty_attack_report_2026-04-12.md`
- 2026-04-12 real-Duc identity continuation: `identity_continuation_goals_report_2026-04-12.md`

### 2026-04-13 University-Finding Frontend Run

Source report:

- `university_finding_frontend_report_2026-04-13.md`

Result:

- Job completed.
- Major soft lock was reproduced, patched, and live-verified fixed: the R5 run advanced to `currentStage: "uni"` with `major.done=true`.
- University did not complete. It still has a meta-question loop after evidence appears and needs another hardening pass before a full university recommendation run.

Main fixes:

- Major curriculum research rules now avoid overpacked no-result queries.
- Major stage boundary now assigns school-specific proof to University.
- Major scorer has a narrow handoff floor for Product BA/UX MIS when only named-school proof remains.
- University official source domains now include UEH, UEL, FPT, RMIT, and USTH.
- University prompts now warn against asking for page type or re-asking column priority after the student already gave the order.
