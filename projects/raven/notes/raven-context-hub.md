...
This hub keeps Raven project state out of root context files.

```text
context/now.md
  -> points to Raven routes
...
Root context should point here when Raven detail would otherwise bloat session startup.
